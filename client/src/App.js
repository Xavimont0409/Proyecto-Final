  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route path="/detailProfile/:id" element={<DetailProfile setValidateState={setValidateState} setCurrentUserStore2={setCurrentUserStore2} />} />
